...
Meaning comes from the permeability of sound, and the audience
...
The 2 Cents Movement supplements their visual documentation with their
...
I agree with Kate Eichhorn, who argues that most poetry sound archives
...
Anne Murray and Jared Wiercinski, curators of SpokenWeb, a digital
...
[^15]: While there are Caribbean sound archives, such as RadioHaiti
    (http://radiohaitilives.com), in Caribbean literary studies print
    archiving is much more prevalent. For example, major collections,
    such as the Digital Library of the Caribbean (http://www.dloc.com),
    while excellent, primarily hold literary materials converted from
    print documents.
...
[^19]: In this draft version of the article, I have included URLs in the
    footnotes. In the final online version, I plan to include hyperlinks
...
[^27]: See their Twitter page: https://twitter.com/2CentsMovement. Since
    it is difficult to search for photos on Twitter, see also individual
    albums on their Facebook page, where some of their school tour
    photos are collected. For example, see the album “Five Rivers Sec –
    Speak Out Tour 2014 – Day 27”:
...
[^29]: Rick Prelinger, “The Appearance of Archives,” in *The YouTube
    Reader*, ed. Pelle Snickars and Patrick Vonderau (Stockholm:
...
[^39]: Linton Kwesi Johnson, “Di Great Insohreckshan,” YouTube video,
    ...
    On the Poetry Archive site, see
    http://www.poetryarchive.org/poet/linton-kwesi-johnson. There are a
    few recordings of “Di Great Insohreckshan” on YouTube. I would argue
    that all of them provide more access to the total expression than
    the Poetry Archive recording, especially if studied comparatively;
    however, I analyze this 2008 Venezuela performance because the
    recording captures the audience’s presence.
...
[^42]: Martin Spinelli, “Analog Echoes: A Poetics of Digital Audio
    ...
    Spinelli criticizes how poetry sound editing is too influenced by
    traditional radio theory. He questions why most archived poetry
...
[^46]: See PennSound’s manifesto, where they outline their principles
    for archiving: http://writing.upenn.edu/pennsound/manifesto.php.
