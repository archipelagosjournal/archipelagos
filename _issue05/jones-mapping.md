...
*archipelagos* presents the *Haitian Revolution Axis Map* (since named *Mapping the Haitian Revolution*)
========================================================================================================
...
country. The [*Haitian Revolution Axis Map*](https://haiti.axismaps.io/)
...
The [*Mapping the Haitian
Revolution*](https://www.mappinghaitianrevolution.com/) project works as
...
History**](http://www.mappinghaitianhistory.com/) in 2007, nothing
...
As a result of this review, we have added a landing page—over which we
have control—with clearer resources for teachers and students. We have
...
[^1]: In the absence of a clear site name, I use *Haitian Revolution
    Axis Map* here (https://haiti.axismaps.io/). The site authors might
    consider providing a definitive title for the project. Editors’
    Note: As a result of this review, the site was named *Mapping the
    Haitian Revolution* (https://www.mappinghaitianrevolution.com/); see
    the site authors’ response, which follows the review.
