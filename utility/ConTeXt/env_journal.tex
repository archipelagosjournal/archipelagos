...
\starttypescript [main]
  \definefontsynonym[HelveticaNeue-Regular]    [name:helveticaneue]
  \definefontsynonym[HelveticaNeue-Italic]     [name:helveticaneueitalic]
  \definefontsynonym[HelveticaNeue-Bold]       [name:helveticaneuebold]
\stoptypescript

\starttypescript [main]
  \setups[font:fallback:sans]
  \definefontsynonym[Sans]                [HelveticaNeue-Regular]    [features=default,fallbacks=emojifallback]
...
\starttypescript [main]
  \definetypeface [main]    [tf] [sans] [main]    [default]
\stoptypescript


\starttypescript [light]
  \definefontsynonym[HelveticaNeue-Regular]    [name:helveticaneuelight]
  \definefontsynonym[HelveticaNeue-Italic]     [name:helveticaneuelightitalic]
\stoptypescript
...
\starttypescript [light]
  \definetypeface [light]    [tf] [sans] [light]    [default]
\stoptypescript
