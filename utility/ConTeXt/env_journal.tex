...
\startsetups[footnote:align]  
  \setupalign[hanging, hz, hyphenated, morehyphenation, verytolerant, stretch, flushleft]
\stopsetups
...
\startsetups[text a]
  sx archipelagos Issue ({\bf\getvariable{article}{issue}}{\bf)}~[~\getvariable{article}{date}~]
\stopsetups
