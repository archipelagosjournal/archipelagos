...
\definefontfamily[light][sans][Helvetica Neue][tf=helveticaneuelight, expansion=quality,protrusion=quality,it=file:helveticaneuelightitalic, sl=file:helveticaneuelightitalic]
...
\setupalign[flushleft, verytolerant, hz, hanging]{%
