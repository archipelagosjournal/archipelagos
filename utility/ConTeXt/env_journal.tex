...
archipelagos~\bullet~\getvariable{article}{date}~\bullet~DOI~\getvariable{article}{DOI}~\bullet~CC-BY 4.0 International~Small~Axe~Project~\bullet~ISSN: 2473-2206\hfill
}
