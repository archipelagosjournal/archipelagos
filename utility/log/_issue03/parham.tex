...
\subsection[title={Brief Introduction},reference={brief-introduction}]
...
.break .dance~also asks readers to look behind the project, to notice citation and origin. Citation is always in process, because I have been learning how I do not always know where things are coming from. I have switched my citational practice into a meditative practice, so those pages are always growing out by growing back.~You can read a more about the background in \quotation{\useURL[url1][\%7B\%7Bsite.baseurl\%7D\%7D/issue03/break-dance-process/index.html][][Breaking, Dancing, Making in the Machine: Notes on .break .dance]\from[url1],} or you can begin .break .dance by clicking on the image below.

\thinrule

\useURL[url2][\%7B\%7Bsite.baseurl\%7D\%7D/issue03/break-dance/index.html\#go][][{\externalfigure[{{site.baseurl}}/images/issue03/bd-enter.png]}]\from[url2]\{:target="_blank"\}
