...
\setupinteraction[title={Musical Passage: A Voyage to 1688 Jamaica},author={Laurent Dubois, David Garner, Mary Caton Lingold}, date={May 2016}, subtitle={Musical Passage}]
...
\subsection[reference={sx-archipelagos-presents-musical-passage},
bookmark={*sx archipelagos* presents {\em Musical Passage}},
title={{\em sx archipelagos} presents {\em Musical Passage}}]
...
\subsection[reference={response-from-the-creators-of-musical-passage},
bookmark={Response from the creators of *Musical Passage*},
title={Response from the creators of {\em Musical Passage}}]
