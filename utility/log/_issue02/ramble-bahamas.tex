...
This page is almost perfect. One small confusion between {\em items} and {\em stories} can be clarified. As far as we can see, an item is a story. However, this is very different from the conception of {\em item} native to Omeka and familiar to Omeka users.\footnote{Omeka is the open-source web publishing platform used by {\em Ramble Bahamas}; see \useURL[url4][http://omeka.org/about/][][omeka.org/about]\from[url4].} We would simply rebrand the headings to \quotation{Browse Stories} or \quotation{Stories.} This would go a long way to making this page clearer. To seal the deal, we would have a brief blurb above or below the map explaining what a {\em story} is.
