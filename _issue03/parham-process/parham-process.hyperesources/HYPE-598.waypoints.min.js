...
"right-in-view":function(){return this.context.innerWidth()-this.adapter.outerWidth()}};window.HYPE_w_598=b})();
(function(){function b(a){window.setTimeout(a,1E3/60)}function d(n){this.element=n;this.Adapter=e.Adapter;this.adapter=new this.Adapter(n);this.key="waypoint-context-"+a;this.didResize=this.didScroll=!1;this.oldScroll={x:this.adapter.scrollLeft(),y:this.adapter.scrollTop()};this.waypoints={vertical:{},horizontal:{}};n.waypointContextKey=this.key;f[n.waypointContextKey]=this;a+=1;this.createThrottledScrollHandler();this.createThrottledResizeHandler()}var a=0,f={},e=window.HYPE_w_598,c=window.onload;
...
(function(){function b(){}function d(b){this.options=a.Adapter.extend({},d.defaults,b);this.axis=this.options.horizontal?"horizontal":"vertical";this.waypoints=[];this.createWaypoints()}var a=window.HYPE_w_598;d.prototype.createWaypoints=function(){for(var a=this,b={vertical:[{down:"enter",up:"noop",offset:function(){return this.context.innerHeight()-a.options.elementOffset}},{down:"noop",up:"exit",offset:function(){return this.context.innerHeight()}},{down:"exit",up:"noop",offset:function(){return-this.adapter.outerHeight()}},
...
b;a++)this.waypoints[a].destroy();this.waypoints=[]};d.defaults={enter:b,entered:b,exit:b,exited:b,noop:b};a.hypeS=d})();(function(){var b=[];null!=window.HYPE_wdtl_598&&(b=window.HYPE_wdtl_598.slice(0));window.HYPE_wdtl_598=null;for(var d=0;d<b.length;d++)b[d]()})();})();
