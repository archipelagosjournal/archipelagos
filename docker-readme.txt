...
$ docker cp ./_issue06/leger-review.md issue06:/app/_issue06/leger-review.md
...
app# utility/ConTeXt/makeSinglePaper.sh _issue06 leger-review.md

# When done copy the PDFs back to host
$ docker cp issue06:/app/assets/issue06/ ./assets/
$ docker cp issue06:/app/assets/issue06/leger-review.pdf ./assets/issue06/leger-review.pdf
